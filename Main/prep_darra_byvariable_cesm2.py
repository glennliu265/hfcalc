...
Note: Abandoning this for now... need to work with package dependencies

Prepare data by variable (forHFF Calculation)
copied from [predict_amv/prep_data_byvariable]



- Crops the data to a given region/time period
- Merges by ensemble (or time) and computes ensemble average
